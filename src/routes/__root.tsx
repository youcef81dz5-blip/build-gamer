  ...
  head: () => ({
    meta: [
      ...
      { title: "NEONFORGE — PC Builder & Game FPS Estimator" },
      {
        name: "description",
        content:
          "Build a gaming PC with live compatibility checks, wattage and price totals, and predicted FPS for the games you play.",
      },
      { name: "theme-color", content: "#0b0d14" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-title", content: "NEONFORGE" },
      { property: "og:title", content: "NEONFORGE — PC Builder & Game FPS Estimator" },
      {
        property: "og:description",
        content: "Real-time PC part compatibility plus a dynamic game FPS predictor.",
      },
